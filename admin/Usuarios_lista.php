...
$query_DatosUsuarios = "SELECT * FROM usuario ORDER BY usuario.strNombre ASC";
$DatosUsuarios = mysql_query($query_DatosUsuarios, $conexionsystem) or die(mysql_error());
...
<div class="container">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <td width="199"><tr class="tablaprincipal">
      <td width="147">id</td>
