...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE categoria SET strDescripcion=%s WHERE idCategoria=%s",
...
$varCategoria_Categoria = "0";
if (isset($_GET["recordID"])) {
  $varCategoria_Categoria = $_GET["recordID"];
}
mysql_select_db($database_conexionsystem, $conexionsystem);
$query_Categoria = sprintf("SELECT * FROM categoria WHERE categoria.idCategoria = %s", GetSQLValueString($varCategoria_Categoria, "int"));
$Categoria = mysql_query($query_Categoria, $conexionsystem) or die(mysql_error());
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="strDescripcion" value="<?php echo htmlentities($row_Categoria['strDescripcion'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
      </tr>
      <tr valign="baseline">
