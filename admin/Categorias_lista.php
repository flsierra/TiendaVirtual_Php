...
$query_Recordset1 = "SELECT * FROM categoria ORDER BY categoria.strDescripcion ASC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $conexionsystem) or die(mysql_error());
...
<div class="container">
  ...
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#CCFFFF">Nombre de Categoria</td>
      <td bgcolor="#CCFFFF">Acciones</td>
    </tr>
    <?php do { ?>
      <tr>
        <td><?php echo $row_Recordset1['strDescripcion']; ?></td>
        <td><a href="Categorias_edit.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">Editar </a>- <a href="categoria_delete.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">Eliminar</a></td>
      </tr>
