...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE productos SET strNombre=%s, strSEO=%s, dblPrecio=%s, intEstado=%s, intCategoria=%s, strImagen=%s WHERE idProducto=%s",
...
mysql_select_db($database_conexionsystem, $conexionsystem);
$query_ConsultaCategoria = "SELECT * FROM categoria ORDER BY categoria.strDescripcion ASC";
$ConsultaCategoria = mysql_query($query_ConsultaCategoria, $conexionsystem) or die(mysql_error());
...
'width=400,heigh=150,location=no,scrollbars=yes,mnubars=no,toolbars=no,resizable=yes,fullscreen=no, status=yes')
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table width="462" height="244" align="center">
      <tr valign="baseline">
